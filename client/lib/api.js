    ...
    var api = {
        ...
        blenderMode: {
            enable: function () {
                ...
                api.services.armsPauMux.callService(new ROSLIB.ServiceRequest({topic: "/blender_api/get_pau"}), function () {
                    return 0;
                });
            },
            disable: function () {
                ...
                api.services.armsPauMux.callService(new ROSLIB.ServiceRequest({topic: "/" + api.config.robot + "/no_pau"}), function () {
                    return 0;
                });
            },
